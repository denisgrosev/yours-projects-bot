...
WELCOME_TEXT = (
    "Привет! Это бот «Твои проекты🖨️», который автоматически создаёт учебные работы (курсовые, доклады, рефераты) по вашим параметрам: тема, предмет, титулка заполняется АВТОМАТИЧЕСКИ. Забудьте о бессонных ночах — бот всё сделает быстро и качественно."
)
...
COST_TEXT = (
    ...
    "– Честная оплата: вы платите только за готовый контент, без скрытых комиссий и предоплаты."
)

PAY_TEXT = (
    "💳 Оплата\n"
    "– Через СБП: мгновенно и без комиссии.\n"
    "– Баланс пополняется автоматически — сразу готов к использованию.\n"
    "– Больше не нужно ждать: оплатили – сразу заказываете следующий раздел в чате."
)
...
REF_TEXT = (
    ...
    "– Свою ссылку и статистику приглашений смотрите в разделе «Реферальная система» стартового меню."
)
